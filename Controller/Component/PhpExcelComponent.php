...
class PhpExcelComponent extends Component {
    ...
    public function createWorksheet() {
        // load vendor classes
        App::import('Spreadsheet.Vendor', 'PHPExcel');
    ...
    public function createReader($file) {
        // load vendor classes
       // App::import('Spreadsheet.Vendor', 'PhpExcel');
		App::import('Vendor', 'Spreadsheet.PHPExcel', array('file' => 'PHPExcel.php'));
		//App::import('Vendor', 'Spreadsheet.PHPExcel_IOFactory', array('file' => 'PHPExcel'.DS.'PHPExcel'.DS.'IOFactory.php'));
        //  Read your Excel workbook
		
        try {
            $inputFileType = PHPExcel_IOFactory::identify($file);
            $objReader = PHPExcel_IOFactory::createReader($inputFileType);
            $this->_xls = $objReader->load($file);
            //$this->setActiveSheet(0);
            $this->_row = 1;
            return $this;
        } catch(Exception $e) {
